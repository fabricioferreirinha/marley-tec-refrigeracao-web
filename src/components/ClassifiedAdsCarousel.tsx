...
const ClassifiedAdsCarousel = () => {
  ...
  // Função para calcular a largura do item baseado no número de itens por view
  const getItemWidth = () => {
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-blue-50 to-orange-50">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="overflow-hidden rounded-xl sm:rounded-2xl">
            <div 
              ...
              style={{ 
                ...
                width: `${Math.max(100, (anuncios.length / itemsPerView) * 100)}%`
              }}
            >
                  ...
                  >
                    <div className="relative">
                      {anuncio.imagens && anuncio.imagens.length > 0 ? (
                        ...
                        <div className="w-full h-36 sm:h-40 lg:h-44 bg-gray-200 flex items-center justify-center">
                    ...
                    <CardContent className="p-3 sm:p-4 flex-1 flex flex-col">
                      ...
                      <p className="text-gray-600 mb-3 sm:mb-4 line-clamp-2 leading-relaxed text-sm sm:text-base flex-1">
                        {anuncio.descricao}
                      </p>
          ...
          {anuncios.length > itemsPerView && (
            <div className="flex justify-center mt-4 sm:mt-6 space-x-2">
              {Array.from({ length: Math.max(1, anuncios.length - itemsPerView + 1) }).map((_, index) => (
                <button
                  key={index}
      ...
      {/* Modal de Detalhes - Mantém a implementação existente mas com melhor responsividade */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      ...
                      {selectedAnuncio.imagens.length > 1 && (
                        <>
                          <button
                            onClick={() => setSelectedImageIndex(prev => prev > 0 ? prev - 1 : 0)}
                          ...
                          <button
                            onClick={() => setSelectedImageIndex(prev => prev < selectedAnuncio.imagens.length - 1 ? prev + 1 : prev)}
                            disabled={selectedImageIndex === selectedAnuncio.imagens.length - 1}
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t space-y-3">
                    ...
                    <Link href="/classificados" className="block">
